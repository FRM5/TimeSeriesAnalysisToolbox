...
# For Duration, proper analysis needs to be done for the related catchments. The durations need to fit the catchment's concentration time. Small
# values, below ~4 hours can be used for pluvial floods in urban areas since they affect the sewage and drainage system, and flash floods as well 
# For Return Periods, the maximum value that can be givem is based on the number of years of the data set. For the case of ~25 years, for return
