...
SPplot <- ggplot(data = SortMat, aes(x=V1, y=V2, fill=V2))+ geom_bar(stat="identity")

grid.arrange(IDFplot, SPplot)

rm(IDF, a, a_sort, ctr, i, j, l, h, b,  melted, aver, sd, z,ts_aggr, ts_full, SP, aver2, Freq, intfinhg, sd2)
