...
rm(MaxMin5, MaxMin15, MaxMin30, MaxHour1, MaxHour2, MaxHour6, MaxHour12, MaxHour24, MaxHour48, Min5, Min15, Min30, Hour1, Hour2, Hour6, Hour12, Hour24, Hour48, z.f, ts_full, z, ts_aggr)
...
StatAnal["Indicators"] <- c("Mean", "St.Dev", "Gumbel: a", "Gumbel: b")
